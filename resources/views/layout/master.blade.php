...
<head>
    ...
    <title>Simasda UNESA - @yield('title')</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block" style="color:black">SIMASDA<span class="" style="color:maroon"></span></span>
            </a>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!-- End Blank Page Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="/usersmanage">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/contentmanage">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>SIMASDAIMM UNESA</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
